...
const translations = {
  ...
  "learning.countdown.short": { en: "Short-term eval in", de: "Kurzfristig-Auswertung in" },
  "learning.countdown.medium": { en: "Medium-term eval in", de: "Mittelfristig-Auswertung in" },
  "learning.countdown.long": { en: "Long-term eval in", de: "Langfristig-Auswertung in" },
  "learning.countdown.days": { en: "days", de: "Tagen" },
  "learning.countdown.today": { en: "today", de: "heute" },
  "learning.countdown.evaluated": { en: "evaluated", de: "ausgewertet" },
  "learning.countdown.needMore": { en: "more needed for learning", de: "weitere n\u00f6tig f\u00fcr Lernen" },
  "learning.countdown.collecting": { en: "Collecting data", de: "Sammelt Daten" },
